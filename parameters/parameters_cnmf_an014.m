...
gSiz = 36; 	% maximum diameter of neurons in the image plane. larger values are preferred. 
ddist = 2; 	% maximum size of the neuron: dist*gSiz
search_method = 'ellipse';	% searching method
merge_thr=0.5; 	% threshold for merging neurons (the higher, the more seed pixels are detected and not merged into 1nu) (default = 0.7)
...
min_corr = 0.5; % Minimum correlation for separating neurons (default = 0.9)
min_pnr = 8;  % min peak-to-noise ratio (default = 20)
min_pixel = 25; % minimum number of (non-negative) pixels that describe the neuron
...
spatial_ds_factor = 1;      % spatial downsampling factor. it's for faster estimation when updating background
